...
with col1:
    ...
    <div class="nav-card">
        ...
        <div class="nav-desc">
            ...
            Point de départ idéal pour valider l'architecture FiLM avant de
            passer au dataset 3D complet.
        </div>
    </div>
    """, unsafe_allow_html=True)
    st.markdown("<div style='height:0.75rem'></div>", unsafe_allow_html=True)
    st.page_link("pages/1_sort_of_clevr.py", label="→ Ouvrir Sort of CLEVR", icon="🔷")
...
with col2:
    ...
    """, unsafe_allow_html=True)
    st.markdown("<div style='height:0.75rem'></div>", unsafe_allow_html=True)
    st.page_link("pages/2_clevr_vqa.py", label="→ Ouvrir CLEVR VQA", icon="🧩")
...
with col3:
    ...
    """, unsafe_allow_html=True)
    st.markdown("<div style='height:0.75rem'></div>", unsafe_allow_html=True)
    st.page_link("pages/3_style_transfer.py", label="→ Ouvrir Style Transfer", icon="🎨")

st.divider()

# ── Comment fonctionne FiLM ────────────────────────────────────────────────────
st.markdown('<div class="section-header">⚗️ Comment fonctionne FiLM ?</div>', unsafe_allow_html=True)
...
st.markdown('<div class="section-header">🗺️ Notre démarche</div>', unsafe_allow_html=True)
