...
with tab_apercu:
    ...
    with c2:
        ...
        items = [
            ...
            ("🖼️", "Images 128×128", "Fond gris, objets avec ombre"),
...
# ══════════════════════════════════════════════════════════════════════════════
with tab_demo:
    st.markdown('<div class="section-header">🖼️ Exemples de scènes générées</div>', unsafe_allow_html=True)
...
# ══════════════════════════════════════════════════════════════════════════════
with tab_archi:
    st.markdown('<div class="section-header">🏗️ Architecture pour Sort of CLEVR</div>', unsafe_allow_html=True)
