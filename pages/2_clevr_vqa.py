...
<div style="padding:0.5rem 0 1rem 0;">
    <div style="font-size:1rem; font-weight:700; color:#818cf8;">⚙️ Configuration</div>
</div>
""", unsafe_allow_html=True)
...
if history:
    ...
    if history.get("film_params"):
        st.markdown('<div class="section-header">🎛️ Distributions γ et β</div>', unsafe_allow_html=True)
        st.markdown("""
    ...
    # Feature maps
    st.markdown('<div class="section-header">🗺️ Feature Maps avant / après FiLM</div>',
                unsafe_allow_html=True)
...
if st.session_state.runs:
    ...
    if st.button("🗑️ Effacer tous les runs"):
